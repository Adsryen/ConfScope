  ...
  return [
    { key: "locale", value: "zh-CN" },
    {
      ...
      value: JSON.stringify({
        ...
        update: { skipVersion: "", lastCheckAt: "2026-08-28T00:00:00.000Z", lastSeenVersion: "1.9.1" },
        compare: { sortConnections: true, sortNamespaces: true },
        startup: {
          lastOpenedVersion: "1.9.1",
          lastShownWelcomeVersion: "1.9.1",
          lastShownChangelogVersion: "1.9.1",
        },
      }),
    },
    {
